...
package com.github.shannah.oaitest52;
 ...
 * @author Shai Almog
 */
public class OaiTest52Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Oai Test 52";
    private static final String APP_NAME = "oai-test-52";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new OaiTest52Stub());
    }
